...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { description: @coupon.description, redemption_limit: @coupon.redemption_limit, title: @coupon.title, valid_from: @coupon.valid_from, valid_until: @coupon.valid_until }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { description: @coupon.description, redemption_limit: @coupon.redemption_limit, title: @coupon.title, valid_from: @coupon.valid_from, valid_until: @coupon.valid_until }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
